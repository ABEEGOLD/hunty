    ...
    <ThemedView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <ThemedCustomText variant="body" style={styles.copy}>
          Hunty mobile transaction flows currently run on Stellar Testnet. Your wallet appears to be
          on Mainnet.
        </ThemedCustomText>
      </View>
      ...
      <View style={styles.steps}>
        <ThemedCustomText variant="label" weight="700">
          1. Open your wallet app settings.
        </ThemedCustomText>
        <ThemedCustomText variant="label" weight="700">
          2. Find Network and select Stellar Testnet.
        </ThemedCustomText>
        <ThemedCustomText variant="label" weight="700">
          3. Return to Hunty and retry the transaction.
        </ThemedCustomText>
      </View>
